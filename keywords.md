...
come accedere alle risorse del computer tramite terminale

# capacità relazionali:

per completare il lavoro a meno che non si sia completamente in smartworking, bisogna avere delle abilità nel creare un buon rapporto con gli altri e nell' avere modo di comunicare in modo sintetico e assertivo le cose che si vogliono fare o che si deve fare cercando di spronare gli altri a dare il meglio di se e nella capacità di gestire eventuali conflitti.
